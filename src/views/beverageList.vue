  ...
  <ion-page id="main-content">
    <ion-header>
      <ion-toolbar>
        ...
        <ion-title>BEVERAGES AVAILABLE</ion-title>
      </ion-toolbar>
    </ion-header>
    <ion-content class="ion-padding">
        ...
        <ion-list>
            <ion-radio-group value="">
                <ion-item v-for = "food in foods" :key="food">
                    ...
                    <ion-img src ='assets/upload/img/SOFT DRINK-200x200.jpg' class="img-static">
                    </ion-img>
                    </IonAvatar>
    ...
    export default defineComponent({
      components: {
        ...
        methods: {
            ...
            loadFoods(){ 
                axios.get('http://localhost:80/api/beverages.php')
                .then((response) => {
